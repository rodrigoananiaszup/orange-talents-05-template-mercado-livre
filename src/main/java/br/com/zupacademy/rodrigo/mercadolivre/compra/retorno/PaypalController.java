...
@RestController
@RequestMapping("/compras/retorno/paypal")
public class PaypalController {
	 ...
	 @Autowired
	    ...
	    @Transactional
	    public String confirmaPagamento(@PathVariable(name = "idCompra") Long idCompra, @RequestBody @Valid PaypalRequest pagamentoRequest) throws BindException{
	        ...
	        if(optional.isPresent()){
	            ...
	            if(compra.getStatusCompra().equals(StatusCompra.FINALIZADA)){
	                ...
	                BindException compraFinalizada = new BindException(pagamentoRequest, "PagamentoPagSeguroDto");
